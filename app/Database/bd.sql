...
CREATE TABLE `faturas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `data` date NOT NULL,
  `valor_preco_total` decimal(8,2) NOT NULL,
  `valor_iva_total` decimal(8,2) NOT NULL,
...
CREATE TABLE `ivas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `percentagem` varchar(3) NOT NULL,
...
CREATE TABLE `produtos` (
  ...
  `descricao` varchar(50) NOT NULL,
  `preco_unid` decimal(8,2) NOT NULL,
  `quant_stock` int(50) NOT NULL,
  `iva_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `referencia` (`referencia`),
	CONSTRAINT fk_prods_idIva FOREIGN KEY (`iva_id`) REFERENCES ivas(`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `linhas` (
  ...
  `valor_iva` decimal(8,2) NOT NULL,
